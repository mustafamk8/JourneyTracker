...
<body>
	...
	<div class="container-fluid">
		<div class="overview">
			<div class="title">
				<h2 class="m-4">
					<i class="uil uil-briefcase"></i>All Certificates
				</h2>
		...
		<table class="table table-responsive-sm text-center">
			...
			<tbody class="rows">
				...
				<tr>
					<td><%=c.getCertiName()%></td>
					<td><%=c.getCertiPlateform()%></td>
					<td><%=c.getCertiCompletionDate()%></td>
					<td><a href="<%=c.getCertiUrl()%>">click here</a></td>
					<td><a
						href="UpdateCertificate?cid=<%=c.getCertiId()%>&&sid=<%=c.getsId()%>"
						class="btn btn-sm edit"><i class="fas fa-edit"></i>Edit</a> <a
						href="DeleteStudentCertificate?id=<%=c.getCertiId()%>" class="btn btn-sm delete"
