...
<body>
	...
	<div class="container-fluid">
		<div class="overview">
			<div class="title">
				<h2 class="m-4">
					<i class="uil uil-briefcase"></i>All Achievement
				</h2>
		...
		<table class="table table-responsive-sm text-center">
			...
			<tbody class="rows">
				...
				<tr>
					<td><%=a.getAchieveName()%></td>
					<td><a
						href="UpdateAchievement?id=<%=a.getAchId()%>&&sid=<%=a.getsId()%>"
						class="btn btn-sm edit"><i class="fas fa-edit"></i>Edit</a> <a
						href="DeleteStudentAchievement?id=<%=a.getAchId()%>"
