...
<body>
	...
	<div class="container-fluid">
		<div class="overview">
			<div class="title">
				<h2 class="m-4">
					<i class="uil uil-briefcase"></i>All Internship
				</h2>
		...
		<table class="table table-responsive-sm text-center">
			...
			<tbody class="rows">
				...
				<tr>
					<td><%=i.getTrName()%></td>
					<td><%=i.getOrgName()%></td>
					<td><%=i.getTrStartDate()%></td>
					<td><%=i.getTrEndDate()%></td>
					<td><a href="<%=i.getTrCerti()%>">click here</a></td>
					<td><a
						href="UpdateInternship?id=<%=i.gettId()%>&&sid=<%=i.getsId()%>"
						class="btn btn-sm edit"><i class="fas fa-edit"></i>Edit</a> <a
						href="DeleteStudentInternship?id=<%=i.gettId()%>"
