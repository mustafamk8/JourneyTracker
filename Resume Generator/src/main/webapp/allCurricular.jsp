...
<body>
	...
	<div class="container-fluid">
		<div class="overview">
			<div class="title">
				<h2 class="m-4">
					<i class="uil uil-briefcase"></i>All Curricular
				</h2>
		...
		<table class="table table-responsive-sm text-center">
			...
			<tbody class="rows">
				...
				<tr>
					<td><%=c.getCurricularName()%></td>
					<td><a
						href="UpdateCurricular?id=<%=c.getCurrId()%>&&sid=<%=c.getsId()%>"
						class="btn btn-sm edit"><i class="fas fa-edit"></i>Edit</a> <a
						href="DeleteStudentCurricular?id=<%=c.getCurrId()%>"
