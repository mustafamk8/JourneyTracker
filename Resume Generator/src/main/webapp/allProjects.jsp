...
<body>
	...
	<div class="container-fluid">
		<div class="overview">
			<div class="title">
				<h2 class="m-4">
					<i class="uil uil-briefcase"></i>All Projects
				</h2>
		...
		<table class="table table-responsive-sm text-center">
			...
			<tbody class="rows">
				...
				<tr>
					...
					<td><%=p.getProjectRole()%></td>
					<td><%=p.getProjectDuration()%></td>
					<td><a href="<%=p.getProjectLink()%>">click here</a></td>
					<td><a
						href="UpdateProject?pid=<%=p.getProjectId()%>&&sid=<%=p.getsId()%>"
						class="btn btn-sm edit"><i class="fas fa-edit"></i>Edit</a> <a
						href="DeleteStudentProject?id=<%=p.getProjectId()%>"
