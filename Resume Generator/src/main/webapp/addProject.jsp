...
<body>
	...
	<form method="post" action="InsertProject">
		...
		<div class="form-group my-3">
			<input type="hidden" name="scholar" value="<%=s.getScholarNo() %>" class="form-control" id="scholar"
			...
			<div class="box">
					...
					<div class="col">
						<div class="form-group my-3">
							<label for="Project">Project Name</label> <input
								name="ProjectName" type="text" class="form-control" id="ProjectName"
								placeholder="Mention Project Name">
						</div>
					</div>
					<div class="col">
						<div class="form-group my-3">
							<label for="ProjectDisc">Project Description in Short</label>
							<textarea name="ProjectDesc" rows="3" type="text"
								class="form-control" id="ProjectDisc"
				...
				<div class="form-row">
					<div class="form-group my-3">
						<label for="ProjectRole">Your Role in Project</label> <input
							name="ProjectRole" type="text" class="form-control" id="ProjectRole"
							placeholder="Mention Your Role in Project">
					</div>
					<div class="form-group my-3">
						<label for="ProjectDuration">Project Duration (in Months)</label>
						<input name="ProjectDuration" type="number" class="form-control"
							id="ProjectDuration"
				...
				<div class="form-group my-3">
					<label for="ProjectLink">Project URL (if Available)</label> <input
						name="ProjectLink" type="url" class="form-control" id="ProjectLink"
