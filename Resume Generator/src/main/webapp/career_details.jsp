...
<body>
	...
	<form action="InsertCareerDetails" method="post">
		<h1 class="text-center">Additional Information</h1>
		<%@include file="components/message.jsp"%>
		
			<div class="form-group my-3">
				<input type="hidden" name="scholar" value="<%=s.getScholarNo() %>" class="form-control" id="ScholarNo"
					placeholder="Enter Scholar No.">
				<div class="form-group my-3">
					<label for="CareerObj">Career Objective</label>
					<textarea type="text" name="st_career"
						 class="form-control"
						id="CareerObj" placeholder="Enter Career Objective"></textarea>
				</div>
			</div>
			<div class="row">
