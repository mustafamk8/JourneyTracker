...
<body>
	...
	Certificates c = (Certificates)request.getAttribute("certi");
	%>
	...
	<form method="post" action="UpdateCertificate">
		<h1 class="text-center">Certificate Information</h1>
		<%@include file="components/message.jsp"%>
		<div class="form-row">
		<div class="form-group  my-3">
				<input type="hidden" name="cid" value="<%=c.getCertiId()%>"
		...
		<div class="row">
			<div class="form-group col-md-6 my-3">
				<label for="CertificateName">Certificate Name</label> <input
					type="text" name="cer_name" value="<%=c.getCertiName() %>" class="form-control"
					id="CertificateName" placeholder="Enter Certificate Name">
			</div>
			<div class="form-group col-md-6 my-3">
				<label for="Upload">Certificate url</label> <input type="url"
					name="cer_url" value="<%=c.getCertiUrl() %>" class="form-control" id="Upload">
			</div>
		</div>
		<div class="row">
			<div class="form-group col-md-6 my-3">
				<label for="CompletionDate">Date of Completion</label> <input
					type="month" name="cer_date" value="<%=c.getCertiCompletionDate() %>" class="form-control"
					id="CompletionDate">
			</div>
			<div class="form-group col-md-6 my-3">
				<label for="Platform">Platform</label> <input type="text"
					name="cer_plat" value="<%=c.getCertiPlateform() %>" class="form-control" id="Platform"
