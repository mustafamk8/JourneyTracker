	...
	<div class="container-fluid">
		...
		<table class="table table-responsive-sm text-center">
			...
			<tbody class="rows">
				...
				List<StudentPersonel> list = model.getAllStudents();
				int i = 0;
				for (StudentPersonel s : list) {
					i++;
				%>
				...
				<tr>
					...
					<td><%=s.getStEnroll()%></td>
					<td><%=s.getStDept()%></td>
					<td><a href="../UpdateStudentInfo?sid=<%=s.getScholarNo()%>"
						class="btn btn-sm edit"><i class="fas fa-edit"></i>Edit</a> <a
						href="../DeleteStudent?id=<%=s.getScholarNo()%>"
