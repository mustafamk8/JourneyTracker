...
<body>
	...
	Achievement a = (Achievement)request.getAttribute("achieve");
	%>
	...
	<form method="post" action="UpdateAchievement">
		<h1 class="text-center">Update Your Achievement</h1>
		<%@include file="components/message.jsp"%>
		<div id="skills">
		<div class="form-group my-3">
				<input type="hidden" name="id" value="<%=a.getAchId() %>"
			...
			<div class="form-group my-3">
				<label for="skill">Achievement :</label> <input type="text" name="achieve"
					value="<%=a.getAchieveName() %>" class="form-control skill-input" placeholder="Enter Achieve">
			</div>
		</div>
