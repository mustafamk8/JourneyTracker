...
<body>
	...
	<form method="post" action="InsertInternship">
				...
				<div class="row">
					<div class="form-group col-md-6 my-3">
						<label for="StartDate">Start Date</label> <input type="month"
							name="start" value="" class="form-control" id="StartDate">
					</div>
					<div class="form-group col-md-6 my-3">
						<label for="CompletionDate">Date of Completion</label> <input
							type="month" name="end" value="" class="form-control"
							id="CompletionDate">
					</div>
				</div>
				<div class="form-group my-3">
					<label for="Upload">Upload Training Certificate</label> <input
						type="url" name="certi" value="" class="form-control" id="Upload">
				</div>
				<br /> <br />
			</div>
		</div>
