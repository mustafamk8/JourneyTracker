...
<body>
	...
	Curricular c = (Curricular)request.getAttribute("curri");
	%>
	...
	<form method="post" action="UpdateCurricular">
		<h1 class="text-center">Update your Curricular Activities</h1>
		<%@include file="components/message.jsp"%>
		<div id="skills">
		<div class="form-group my-3">
				<input type="hidden" name="id" value="<%=c.getCurrId() %>"
			...
			<div class="form-group my-3">
				<label for="skill">Curricular :</label> <input type="text" name="curri"
					value="<%=c.getCurricularName() %>" class="form-control skill-input" placeholder="Enter skill">
			</div>
		</div>
