...
<body>
	...
	Skill sk = (Skill)request.getAttribute("skill");
	%>
	...
	<form method="post" action="UpdateSkill">
		<h1 class="text-center">Update your Skillset</h1>
		<%@include file="components/message.jsp"%>
		<div id="skills">
		<div class="form-group my-3">
				<input type="hidden" name="id" value="<%=sk.getSkillId() %>"
			...
			<div class="form-group my-3">
				<label for="skill">Skill:</label> <input type="text" name="skill"
					value="<%=sk.getSkillName() %>" class="form-control skill-input" placeholder="Enter skill">
			</div>
		</div>
